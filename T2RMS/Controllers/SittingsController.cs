...
namespace T2RMSWS.Controllers
{
    public class SittingsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var applicationDbContext = _context.Sittings.Include(s => s.SittingStatus).Where(s => s.StartDateTime >= mondayOfWeek && s.StartDateTime <= sundayOfWeek).Include(s => s.SittingType);          
